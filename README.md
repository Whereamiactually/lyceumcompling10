...
| 13.11.23 | Морфологические анализаторы: MyStem, PyMorphy, SpaCy (Dependency parsing). Разбор контрольной работы. Разбор домашней работы по морф. обработке текста. | №3. Задания в конце тетрадки (совсем простенькие). Морф. анализаторы. | 20.11.23 23:59 ||
