...
| 08.04.24 | Контрольная работа: краулинг, pandas, TF-IDF.| Загружайте [сюда](https://forms.gle/sRnKtCyhuJnoJe2Y7). || [задание](https://colab.research.google.com/drive/1P8q0DHS8GkI6x-lbB1EASHy2aymvKXMv?usp=sharing) |
| 15.04.24 | Продолжение контрольной работы. ||||
| 22.04.24 | Продолжение контрольной работы. ||||
| 29.04.24 | Подготовка к проекту по векторизации текста. | Вам нужно разбиться на команды по три человека. Вашей задачей будет превращение любого оригинального художественного текста с помощью модели Word2Vec в аналогичный, но использующий другие слова. Подробнее мы ещё с вами это обсудим. |||
...
|||Новый учебный год!|||
| 06.09.24 | Повторение: морфологические анализаторы, распознавание именованных сущностей, pandas, краулинг. ||||
||||||
||||||
||||||
